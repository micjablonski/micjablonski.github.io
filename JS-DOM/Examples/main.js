...
/* let paragraph = document.querySelector('.content'); // Zwraca pierwszy selector i go zwraca
...
console.log(allParagraphs); //Parametr- nazwa tagu HTML, zwraca obiekt */
...
butSumUp.removeEventListener('click', sumUp); */
//Funkcja getEvensLisener używana tylko w konsoli
